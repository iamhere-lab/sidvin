...
(function () {
  ...
  function loadMsg91() {
    ...
    msg91Ready = new Promise(function (resolve, reject) {
      ...
      s.onerror = function () { reject(new Error('Could not load MSG91.')); };
  ...
  function retryOtp(identifier) {
    ...
    return loadMsg91().then(function () {
      return new Promise(function (resolve, reject) {
        // channel 11 = SMS
        window.retryOtp('11', resolve, function (e) {
  ...
  function initForm(form) {
    ...
    function doSend(isRetry) {
      ...
      var call = isRetry ? retryOtp(identifier) : sendOtp(identifier);
